  ...
  ),
  {
    variants: {
      variant: {
        ...
        Light:
          "bg-primary/10 text-foreground hover:bg-primary/15 dark:bg-primary/20 dark:hover:bg-primary/25",
        outline:
      ...
      size: {
        xs: cn(
          "h-6 gap-1 rounded-[min(var(--radius-md),10px)] px-2 in-data-[slot=button-group]:rounded-lg has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 [&_svg:not([class*='size-'])]:size-3",
